...
public class ChildException extends RuntimeException {
    ...
    public enum ChildErrorCode {
        ...
        PARENT_RELATION_EXISTS("CHILD_006", "가족 관계가 있어 삭제할 수 없습니다. 가족 관계를 먼저 해제해주세요."),
        NO_DELETE_PERMISSION("CHILD_007", "자녀 삭제 권한이 없습니다."),
        PARENT_NOT_FOUND("CHILD_008", "가족 관계를 찾을 수 없습니다."),
        NO_PARENT_DELETE_PERMISSION("CHILD_009", "가족 관계 삭제 권한이 없습니다.");
